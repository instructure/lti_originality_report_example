...
class RegistrationController < ApplicationController
  ...
  def register
    ...
    tcp_helper = Registration::ToolConsumerProfile.new(URI.parse(params[:tc_profile_url]), jwt_access_token)

    # Do failure redirect to tool consumer if missing required
    # TODO check for require services
    ...
    tp_response_helper = Registration::ToolProxyResponse.new(tp_response, registration_redirect_url)
