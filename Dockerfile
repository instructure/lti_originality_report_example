...
ENV INSTALL_PATH /similarity_detection_reference_tool
# The name of the application is similarity_detection_reference_tool and while there
...
# having to CD into the /similarity_detection_reference_tool folder every time would be
# lame, so instead we can set the WORKDIR to be /similarity_detection_reference_tool.
#
...
# similarity_detection_reference_tool/ path inside of the Docker image.
#
# It copies it to /similarity_detection_reference_tool because of the WORKDIR being set.
#
...
# /similarity_detection_reference_tool folder inside of the Docker image.
#
